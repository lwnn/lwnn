...
} layer_cpu_s8_actvation_context_t;
/* ============================ [ DECLARES  ] ====================================================== */
/* ============================ [ DATAS     ] ====================================================== */
/* ============================ [ LOCALS    ] ====================================================== */
static void relu_s8(int8_t* data, size_t sz, int8_t zero)
{
	size_t i;
	for (i = 0; i < sz; i++)
	{
...
static int layer_cpu_s8_activation_init(const nn_t* nn, const layer_t* layer)
{
	...
	r = rte_cpu_create_layer_context(nn, layer, sizeof(layer_cpu_s8_actvation_context_t), 1);
...
static int layer_cpu_s8_activation_execute(const nn_t* nn, const layer_t* layer)
{
	int r = 0;
	layer_cpu_s8_actvation_context_t* context = (layer_cpu_s8_actvation_context_t*)layer->C->context;
...
static void layer_cpu_s8_activation_deinit(const nn_t* nn, const layer_t* layer)
{
	rte_cpu_destory_layer_context(nn, layer);
}
/* ============================ [ FUNCTIONS ] ====================================================== */
int layer_cpu_s8_RELU_init(const nn_t* nn, const layer_t* layer)
{
	return layer_cpu_s8_activation_init(nn, layer);
}

int layer_cpu_s8_RELU_execute(const nn_t* nn, const layer_t* layer)
{
