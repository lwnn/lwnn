...
/* ============================ [ UNSUPPORTED ] ==================================================== */
UNSUPPORTED_LAYER_OPS(cpu_s8, TRANSPOSE)
UNSUPPORTED_LAYER_OPS(cpu_q8, TRANSPOSE)
UNSUPPORTED_LAYER_OPS(cpu_q16, TRANSPOSE)
UNSUPPORTED_LAYER_OPS(cpu_float, TRANSPOSE)
UNSUPPORTED_LAYER_OPS(cl, TRANSPOSE)

UNSUPPORTED_LAYER_OPS(cpu_s8, PRIORBOX)
UNSUPPORTED_LAYER_OPS(cpu_q8, PRIORBOX)
UNSUPPORTED_LAYER_OPS(cpu_q16, PRIORBOX)
UNSUPPORTED_LAYER_OPS(cpu_float, PRIORBOX)
UNSUPPORTED_LAYER_OPS(cl, PRIORBOX)
...
UNSUPPORTED_LAYER_OPS(cpu_float, DETECTIONOUTPUT)
UNSUPPORTED_LAYER_OPS(cl, DETECTIONOUTPUT)
